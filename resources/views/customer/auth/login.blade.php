...
@section('content')
    <form method="post" action="{{route('login')}}">
        ...
        <div class="mb-4 flex">
            <input
                type="password"
                class="password @error('email_or_phone') border-red-600 @enderror block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-r-0 border-solid border-gray-300 rounded rounded-r-none transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                id="password"
