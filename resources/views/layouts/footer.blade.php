<div class="bg-gray-600 text-white grid grid-cols-1 sm:grid-cols-2 m-4">
    <nav class="my-2 sm:border-r-2 sm:border-r-white ml-2">
        <ul class="flex gap-6 justify-around flex-wrap">
            <li><a href="#contact" class="footer-link">Contact</a></li>
            <li><a href="#services" class="footer-link">Services</a></li>
            <li><a href="{{route('price-list')}}" class="footer-link">Pricing</a></li>
            <li><a href="#reviews" class="footer-link">Reviews</a></li>
            <li><a href="#about" class="footer-link">About</a></li>
            <li><a href="#payments" class="footer-link">Payment</a></li>
...
<div class="text-center m-4">
    © 2022 Washer's Inn. All rights reserved.
</div>
