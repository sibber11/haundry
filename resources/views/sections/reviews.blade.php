<section class="flex items-center justify-center py-20 bg-white min-w-screen">
    <div class="px-16 bg-white">
        <div class="container flex flex-col items-start mx-auto lg:items-center">
            ...
            <div class="block w-full h-0.5 max-w-lg mt-6 bg-purple-100 rounded-full"
                 data-primary="purple-600"></div>
            ...
            <div class="items-center justify-center w-full mt-12 mb-4 lg:flex">
                <div class="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0">
                    ...
                    <blockquote class="mt-8 text-lg text-gray-500">
                        "I've been using <b>{{config('app.name')}}</b> for my laundry and dry cleaning needs for the
                        past year, and
                        I couldn't be happier. Their pickup and delivery services are incredibly convenient, and the
                        quality of their cleaning is second to none. I highly recommend them to anyone looking for a
                        reliable and affordable laundry service."
                    </blockquote>
                </div>
                <div
                    ...
                    <blockquote class="mt-8 text-lg text-gray-500">
                        "I've been using <b>{{config('app.name')}}</b> for my business shirts and suits, and I've
                        been impressed by
                        the results every time. They always return my clothes looking crisp and clean, and the
                        prices are very reasonable. I would definitely recommend them to anyone looking for a
                ...
                <div class="flex flex-col items-start justify-start w-full h-auto lg:w-1/3">
                    ...
                    <blockquote class="mt-8 text-lg text-gray-500">"I recently started using
                        <b>{{config('app.name')}}</b> for my
                        family's laundry needs, and I'm blown away by their level of service. Their pickup and
                        delivery services are a lifesaver, and the quality of their cleaning is excellent. I highly
                        recommend them to anyone looking for a convenient and high-quality laundry service."
                    </blockquote>
                </div>
            </div>
        </div>
